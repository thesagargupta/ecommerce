    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          console.log("Section is visible!"); // Debugging
          setIsVisible(true);
        }
      },
      ...
      <div className="story">
        ...
        <div className="content1">
          <p className="para">
            ...
            , an innovative e-commerce platform built to cater to the dynamic
            needs of Indian consumers. Managed by <b>Tehelka Developers</b>, a
            company renowned for its technological expertise and commitment to
            quality,
            ...
            localized shopping experience, <b>Shopers</b> offered a diverse
            range of products—from everyday essentials and groceries to
            cutting-edge electronics, fashion, and home decor. What set the
            platform apart was its deep understanding of India’s diverse
            demographics, offering region-specific products, multilingual
            interfaces, and seamless delivery services even in remote areas.
          </p>
      ...
      <div className="details">
        ...
        <div className="developer">
          ...
          <div className="dev-details">
            <p>
              Sagar Gupta, a visionary developer and entrepreneur, is the
              founder of <b>Shopers</b>, an innovative e-commerce platform, and{" "}
              ...
              his ventures, establishing them as industry leaders. His
              unwavering commitment to <b>technological advancement</b> and{" "}
              <b>customer-centric innovation</b> has positioned <b>Shopers</b>{" "}
              as a formidable competitor in the e-commerce space while cementing{" "}
              <b>Tehelka Developers</b> as a trailblazer in software development
